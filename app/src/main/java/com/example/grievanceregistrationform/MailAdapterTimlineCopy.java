...
public class MailAdapterTimlineCopy extends RecyclerView.Adapter<MailAdapterTimlineCopy.MyViewHolder> {
    ...
    public MailAdapterTimlineCopy(Context mainActivityUser, ArrayList<Mailbean> mailbeans,
    ...
    public MailAdapterTimlineCopy.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.mailaddress_row_copy, parent, false);

        return new MailAdapterTimlineCopy.MyViewHolder(itemView);
    }

    @Override
    public void onBindViewHolder(MailAdapterTimlineCopy.MyViewHolder holder, final int position) {
