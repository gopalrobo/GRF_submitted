...
public class GRMPdfConfig {
    ...
    public static void addContent(Document document, ComplaintLetterbean complaintLetterbean, Handler handler) throws Exception {
        ...
        table1.addCell(createTextCell("", headingFont));
        ...
        table1.addCell(createTextCell("Subject: GRM Resolution letter\n", subFontsub));
        p1.add(new Chunk("Dear Madam/ Sir,\n", subFont));
        p1.setLeading(16);

        p1.add(new Chunk("We are happy to officially communicate you the complaint resolution arrived during the meeting which you and the affected person were present for your complaint registered in the GRM logbook under No #42285-013-0001. Dated: 27-March-2020 of ADB Project # 44285-013 Integrated Urban Environmental Management in the Tonle Sap Basin", subFont));
       /* p1.add(new Chunk("No#"+complaintLetterbean.getId(), subFont));
        ...
        table22.addCell(createTextCell("First level investigation report and Resolution", tableAnsFont));
        ...
        table12.addCell(createTextCellBorderSign("Resolution  ", tableFont));
