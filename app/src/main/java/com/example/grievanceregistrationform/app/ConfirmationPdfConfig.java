...
public class ConfirmationPdfConfig {
    ...
    public static void addContent(Document document, ComplaintLetterbean complaintLetterbean, Handler handler) throws Exception {
        ...
        table1.addCell(createTextCell("COMPLAINT RECEIPT CONFIRMATION NOTICE \n", headingFont));
        ...
        table1.addCell(createTextCell("\nTo\nMr Syden EA \n" +
                "34, Kabal Spean Thma (village),  \n" +
                "Prey Ni (Commune),  Pursat (District), \n" +
                "Pursat (Province), Cambodia, \n" +
                "Mobile: + 855.9080593194, Climtesmarttech2@gmail.com", subFont));


        table1.addCell(createTextCell("Subject: Complaint Receipt Confirmation Notice (Level -1) \n", subFontsub));
        p1.add(new Chunk("Dear \n"+complaintLetterbean.name, subFont));
        p1.setLeading(16);

        p1.add(new Chunk("This is to confirm that the complaint you are representing has been received by the Grievance Redress Group and was registered in the GRM logbook under", subFont));
        ...
        p3.setLeading(16);
        p3.add(new Chunk("The Grievance Redress Group shall review and address your complaint within fifteen (15) days. Please note that we will be undertaking an investigation on your complaint and conducting GRG meetings to review your complaint and your participation during these investigation and meetings will be required ", subFont));
        ...
        table4.addCell(createTextCellBorder("Investigator Name ", subFont));
