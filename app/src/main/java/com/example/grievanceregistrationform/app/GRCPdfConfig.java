...
public class GRCPdfConfig {
    ...
    public static void addContent(Document document, ComplaintLetterbean complaintLetterbean, Handler handler) throws Exception {
        ...
        table1.addCell(createTextCell("GRC MEETING INVITATION NOTICE\n", headingFont));
        ...
        table1.addCell(createTextCell("\nToMr Syden EA \n" +
                ...
                "Mobile: + 855.9080593194, Climtesmarttech2@gmail.com\n", subFont));


        table1.addCell(createTextCell("Subject: GRC  Meeting Invitation\n", subFontsub));
        p1.add(new Chunk("Dear  Mr Syden Ea\n", subFont));
        p1.setLeading(16);

        p1.add(new Chunk("We had concluded our investigation and would like to invite you and affected persons to the Grievance Redress Group meeting to resolve that was registered GRM  logbook under No #42285-013. Dated: 27-March-2020.", subFont));
            ...
            if (complaintLetterbean.getMailbeans().get(i).getImages() != null) {
                ...
                for (int k = 0; k < list.size(); k++) {
                    ...
                    if (projectbeanMap.containsKey(name)) {
                        ...
                        table2.addCell(createTextCellBorderSign(projectbeanTemp.detail, catFont));
                        table2.addCell(createTextCellBorderSign(projectbeanTemp.detail, catFont));
        ...
        p3.setLeading(16);
        p3.add(new Chunk("The meeting will be held on 15 April 2020 at the Commune hall in Prey Ni Commune. Please contact GRC Secretary for further details (Name of GRC Secretary, Phone number and location). ", subFont));
